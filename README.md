...
### 복습 일시
+ 1.개발자 환경 구축 ==================================================
- [평가자 체크 리스트]2001020233_19v4.1 운영체제 기초 활용하기
= [평가자 체크 리스트]2001020233_19v4.2 기본 개발환경 구축하기
- 복습평가일시: 리액트프로그래밍 강의교재 1회차 3교시 마친 후
+ 2.UI구현 ============================================================
[문제해결 시나리오]2001020708_19v3.1 UI 설계 검토하기
[포트폴리오]2001020708_19v3.2 UI 구현 표준 검토하기
- 복습평가일시: 리액트 프로그래밍 2회차 3교시 마친 후
+ 3.프로그래밍 언어 응용 ==============================================
[문제해결 시나리오]2001020230_19v4.1 언어특성 활용하기
[문제해결 시나리오]2001020230_19v4.2 라이브러리 활용하기
- 복습평가일시: 리액트프로그래밍 강의교재 10회차 3교시 마친 후
+ 4.화면구현 ==========================================================
[평가자 체크 리스트]2001020225_19v5.1 UI 설계 확인하기
[평가자 체크 리스트]2001020225_19v5.2 UI 구현하기
- 복습평가일시: 리액트프로그래밍 강의교재 11회차 3교시 마친 후
+ 5.프로그래밍 언어 활용 ==============================================
[평가자 체크리스트]2001020231_19v4.1 구조적 프로그래밍 언어활용하기
[평가자 체크리스트]2001020231_19v4.2 객체지향 프로그래밍 언어활용하기
[평가자 체크리스트]2001020231_19v4.3 스크립트 활용하기
- 복습평가일시: 리액트프로그래밍 강의교재 13회차 2교시 마친 후
++ 6.통합 구현 =========================================================
[평가자 체크 리스트]2001020206_19v5.1 연계 데이터 구성하기
[평가자 체크 리스트]2001020206_19v5.2 연계 메커니즘 구성하기
[평가자 체크 리스트]2001020206_19v5.3 내외부 연계 모듈 구현하기
- 복습평가일시: 넥스트js 강의교재 1회차 2교시 마친 후
-----------------------------------------------------------------------
+ 7.데이터베이스 구현 =================================================
[평가자 체크 리스트]2001020405_19v4.1 DBMS 설치하기
[평가자 체크 리스트]2001020405_19v4.2 데이터베이스 생성하기
[문제해결 시나리오]2001020405_19v4.3 데이터베이스 오브젝트 생성하기
- 복습평가일시: 노드js와 데이터베이스 활용 강의교재 3회차 3교시 마친 후
+ 8.서버프로그램 구현 =================================================
[포트폴리오]2001020211_19v5.1 개발환경 구축하기
[포트폴리오]2001020211_19v5.2 공통 모듈 구현하기
[포트폴리오]2001020211_19v5.3 서버 프로그램 구현하기
[포트폴리오]2001020211_19v5.4 배치 프로그램 구현하기
- 복습평가일시: 노드js와 데이터베이스 활용 강의교재 4회차 2교시 마친 후
+ 9.SQL 활용 ==========================================================
[문제해결 시나리오]2001020413_19v4.1 기본 SQL 작성하기
[평가자 체크리스트]2001020413_19v4.2 고급 SQL 작성하기
- 복습평가일시: 노드js와 데이터베이스 활용 강의교재 7회차 2교시 마친 후
++ 10.인터페이스 구현 ==================================================
[평가자 체크 리스트]2001020212_19v5.1 인터페이스 설계서 확인하기
[평가자 체크 리스트]2001020212_19v5.2 인터페이스 기능 구현하기
[평가자 체크 리스트]2001020212_19v5.3 인터페이스 구현 검증하기
- 복습평가일시: 노드js와 데이터베이스 활용 강의교재 14회차 3교시 마친 후
...
- [자바 강의용 PDF자료 보기](https://github.com/miniplugin/ezen/blob/main/README.md)개강 시 오픈예정{Ctrl+클릭 새창으로}
```
- 과목소개(아래)
...
#### =====================================================
### (구)커리큘럼(예전자료로 사용하지 않는다. 이 문서 상단의 최신 자료를 이용해서 수업한다.)
