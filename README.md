...
### 참고사항
- 1차코스 교재의 8장~14장 사이는 PC용 프로그램 기준으로 클래스를 사용하는 방법을 진행합니다. 이론강의 중 1개 이상의 실습을 하게 됩니다.
...
- 그래서, 8장~14장은 빠르게 진행합니다. 그리고, 각 장의 PPT문서 마지막에 필수로 알아야 할 내용을 아래 추가실습으로 진행할 예정 입니다.
