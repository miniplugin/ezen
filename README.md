...
### 참고사항
- 1차코스 교재의 1장~7장 사이는 자바프로그램의 기초로 클래스를 사용하는 방법을 학습합니다. 각 장의 이론강의 중 1개 이상의 실습을 하게 됩니다.
...
- 그래서, 8장~14장은 빠르게 진행할 예정입니다.
- 그리고, 각 장의 PPT문서 마지막에 필수로 알아야 할 내용을 아래 추가실습으로 진행할 예정 입니다.
