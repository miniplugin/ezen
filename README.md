...
### 복습 일시
+ 1.개발자 환경 구축 =복습평가일시: 리액트프로그래밍 강의교재 1회차 3교시 마친 후
+ 2.UI구현 =복습평가일시: 리액트 프로그래밍 2회차 3교시 마친 후
+ 3.프로그래밍 언어 응용 =복습평가일시: 리액트프로그래밍 강의교재 10회차 3교시 마친 후
+ 4.화면구현 =복습평가일시: 리액트프로그래밍 강의교재 11회차 3교시 마친 후
+ 5.프로그래밍 언어 활용 =복습평가일시: 리액트프로그래밍 강의교재 13회차 2교시 마친 후
+ 6.통합 구현 =복습평가일시: 넥스트js 강의교재 1회차 2교시 마친 후
-----------------------------------------------------------------------
+ 7.데이터베이스 구현 =복습평가일시: 노드js와 데이터베이스 활용 강의교재 3회차 3교시 마친 후
+ 8.서버프로그램 구현 =복습평가일시: 노드js와 데이터베이스 활용 강의교재 4회차 2교시 마친 후
+ 9.SQL 활용 =복습평가일시: 노드js와 데이터베이스 활용 강의교재 7회차 2교시 마친 후
+ 10.인터페이스 구현 =복습평가일시: 노드js와 데이터베이스 활용 강의교재 14회차 3교시 마친 후
