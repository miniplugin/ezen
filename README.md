...
### 학습순서(학생과 함께 문서로 학습정리하는 시간)
+ 1.개발자 환경 구축 : 리액트프로그래밍 강의교재 1회차 3교시 마친 후
+ 2.UI구현 : 리액트 프로그래밍 강의교재 2회차 3교시 마친 후
+ 3.프로그래밍 언어 응용 : 리액트프로그래밍 강의교재 10회차 3교시 마친 후
+ 4.화면구현 : 리액트프로그래밍 강의교재 11회차 3교시 마친 후
+ 5.프로그래밍 언어 활용 : 리액트프로그래밍 강의교재 13회차 2교시 마친 후
+ 6.통합 구현 : 넥스트js 강의교재 1회차 2교시 마친 후
-----------------------------------------------------------------------
+ 7.데이터베이스 구현 : 노드js와 데이터베이스 활용 강의교재 3회차 3교시 마친 후
...
### 학습정리 자료
- [학습정리 자료모음](#)개강 시 오픈예정{Ctrl+클릭 새창으로}
...
```
-![1차 코스 전자계산기 미니프로젝트 결과](./README/calc10_02.jpg)
- [1차 코스 자바 강의용 PDF자료 보기](#)개강 시 오픈예정{Ctrl+클릭 새창으로}
- [1차 코스 문재해결시나리오_작업서식](#) 개강 시 오픈예정{Ctrl+클릭 새창으로}
...
- 학점 산출 프로그램 1차 결과는 수업시간에 같이 진행 아래.(2차결과는 학생 스스로 작업예정)
- ![학점 산출 프로그램 결과](./README/portfolio.jpg)
- 학점 산출 프로그램 클래스 다이어그램.(아래)
- ![학점 산출 프로그램 클래스 다이어그램](./README/classdiagram.jpg)
- [2차 코스 포트폴리오_작업서식](#) 개강 시 오픈예정{Ctrl+클릭 새창으로}

#### =====================================================

### 수업에서 여유 시간이 있다면 아래 메모장 프로그램과 일별박스오피스 프로그램을 학습합니다.
- 과목 후반부는
