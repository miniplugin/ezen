...
import miniproject.p14.sprite.AlienSprite;
import miniproject.p14.sprite.ShotSprite;
import miniproject.p14.sprite.Sprite;
import miniproject.p14.sprite.StarShipSprite;
/**
...
public class GalagaGame extends JPanel implements KeyListener {
	...
	public GalagaGame() {
		...
		try {//이미지를 파일에서 읽어옴
			shotImage = ImageIO.read(new File("./src/miniproject/p14/image/fire.png"));
			shipImage = ImageIO.read(new File("./src/miniproject/p14/image/starship.png"));
			alienImage = ImageIO.read(new File("./src/miniproject/p14/image/alien.png"));
